...
<nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="{{ route('bloghome.index') }}">
            <img src="{{ asset($settings->logo) }}" width="100">
</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto py-4 py-lg-0">
                <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ route('bloghome.index') }}">Home</a></li>
...
<header class="masthead"
        ...
        style="background-image: url('@yield('back_image',asset('front/assets/img/home-bg.jpg'))')">
