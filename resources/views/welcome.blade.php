...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 middle-0 px-6 py-4 sm:block">
                    @auth
                    ...
                    @else
                        ...
                        @endif
                    @endauth
                        <a href="{{ route('bloghome.index') }}" target="_blank" class="ml-4 text-lg text-gray-700 dark:text-gray-500 underline">Blog Home</a>
                </div>
            @endif
                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8" >
                    <div class="flex justify-center pt-8 sm:pt-0">
                        <img src="https://images5.alphacoders.com/555/555700.jpg" height="700" >
                    </div>
